...
# def process(data):
    ...
    # Rajouter un sentiement
    prediction_sentiment = sentiment_analyzer(data_preprocess)
    # Rajouter une personne, lieux, organisation
    prediction_ner = ner_analyzer(data_preprocess)  
    # Rajouter une liste de keywords
    prediction_keyworks = keyword_extractor(data_preprocess)



    # Mise en base de données
    reponse_qestion = predict_answer()
